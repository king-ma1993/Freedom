package com.myl.wanandroid.mvp.ui.activity

import android.os.Bundle
import com.jess.arms.di.component.AppComponent
import com.jess.arms.mvp.IPresenter
import com.tencent.bugly.beta.Beta
import com.myl.wanandroid.BuildConfig
...
import com.myl.wanandroid.mvp.ui.activity.main.MainFragment
...
class MainActivity : BaseActivity<IPresenter>() {
    ...
    override fun initData(savedInstanceState: Bundle?) {
        ...
        if(BuildConfig.APPLICATION_ID != "com.myl.wanandroid"&&BuildConfig.BUGLY_KEY =="5a5f6366fc"){
