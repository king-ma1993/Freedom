...
public class LogUtils {
    public static final String TAG = "HostPluginLib";

    private static final String TAG_PREFIX = TAG + ".";

    /**
     * 是否输出日志？若用的是nolog编译出的AAR，则这里为False
     * 注意：所有使用LogUtils前，必须先用此字段来做判断。这样Release阶段才会被彻底删除掉
     * 如：
     * <code>
     ...
     * 允许Dump出一些内容
     */
    public static final boolean DUMP_ENABLED = isShowLog;
